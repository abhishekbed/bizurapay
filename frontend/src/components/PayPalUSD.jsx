...
import abi from "../abis/abi.json"; // ZK Auth contract ABI
import erc20 from "../abis/erc20.json"; // ERC20 PayPalUSD token ABI
import { useAppKitProvider, useAppKitAccount } from "@reown/appkit/react";

const contarctAddress = "0x8F903e8bC7099AEc23dE021782cBa0d0f93F7b7f"; // ZK Auth contract
const paypalUSDAddress = "0xCaC524BcA292aaade2DF8A05cC58F0a65B1B3bB9"; // PayPalUSD ERC20 token
...
export default function PayPalUSD() {
    ...
    const [qrAmount, setQrAmount] = useState(""); // Amount for QR code
...
//                 // Depending on Solidity, use array or object
//                 const verified = data.isVerify ?? data[1];
//                 setIsVerified(verified);
//             } catch (err) {
//                 console.error("Verification check failed:", err);
